...
-- Script para importar solo los usuarios que faltan

BEGIN;

-- Insertar usuarios que no existen (usando INSERT ... ON CONFLICT DO NOTHING para evitar duplicados)
...
-- Insertar viajes que pueden haber fallado antes
...
SELECT 'USUARIOS INSERTADOS:' as tipo, COUNT(*) as total FROM users;
SELECT 'VIAJES INSERTADOS:' as tipo, COUNT(*) as total FROM travels;

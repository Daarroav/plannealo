...
-- Script para importar TODOS los datos faltantes: notas, actividades y alojamientos

BEGIN;

-- 1. Insertar TODOS los alojamientos de producción
...
-- Alojamientos de ALEMANIA (ya insertados anteriormente)
...
-- Alojamientos de PARIS Y BUDAPEST (ya insertados anteriormente)
...
-- Alojamientos adicionales de otros viajes
...
('bdb7b6b1-077c-47c0-ac8c-af5420ef7839', '5948ede8-258b-4cd3-9f44-be08adccf9d5', 'Premier Inn Berlin Alexanderplatz', 'hotel', 'Theanolte-Bähnisch-Straße 2, Berlin, 10178 Alemania', '2025-10-18 21:00:00', '2025-10-20 17:00:00', '1 Doble estandar', '', '2481055762', '', '', '', ARRAY['/uploads/accommodations/attachments-1758593283241-808469141.pdf']),
('ca24e3f8-2d8b-4e98-beab-e5a8e3e6ecef', '5948ede8-258b-4cd3-9f44-be08adccf9d5', 'Eurostars Book Hotel', 'hotel', 'Neuhauser Str. 31, Munich, 80331 Alemania', '2025-10-20 21:00:00', '2025-10-22 17:00:00', '1 Doble estandar', '', '#2278092273', '', '', '', ARRAY['/uploads/accommodations/attachments-1758668279561-706844228.pdf'])

ON CONFLICT (id) DO NOTHING;

-- 2. Insertar TODAS las actividades de producción
...
-- Actividades de ALEMANIA (ya insertadas anteriormente)
...
-- Actividades de PARIS Y BUDAPEST (ya insertadas anteriormente)
...
('afee4eb7-94d4-4c9f-a9c8-e96d6ab8ea0d', 'b9a2864e-c91c-491b-b3a8-8c24cab30c33', 'Spa Cenotes', 'spa', 'Xcaret', '2025-09-02 15:50:00', '09:50', '10:00', '658822', '', 'Contacto: Andrés - Tel: 4598326269 Ubicación inicio: Hotel Ubicación fin: Hotel', '', '', '', '', ARRAY[]::text[]),
('7ec19d30-deca-4f2b-9563-41a6a72eb51d', 'b9a2864e-c91c-491b-b3a8-8c24cab30c33', 'Cena en Xe''Ha''', 'evento', 'Xcaret México', '2025-09-07 15:00:00', '09:00', '11:00', 'ACTE2986', '', 'Contacto: Fernanda Bueno - Tel: 98757245 Ubicación inicio: No aplica Ubicación fin: No aplica', '', '', '', '', ARRAY[]::text[]),
('c17dfc8e-caea-4147-989b-21dcc2481a40', 'b9a2864e-c91c-491b-b3a8-8c24cab30c33', 'Cenotes de Playa del Carmen', 'tour', 'Xcaret', '2025-09-03 13:00:00', '07:00', '05:00', 'ACT238563480', 'No incluye políticas de cancelación.', 'Contacto: Fernanda Bueno - Tel: 2324976008 Ubicación inicio: Lobby hotel Ubicación fin: Libby Hotel Protector solar biodegradable.', '', '', '', '', ARRAY[]::text[]),
...
-- 3. Insertar TODAS las notas de producción
...
SELECT '', '', ''
UNION ALL
SELECT 'VIAJES POR ESTADO', '', ''
UNION ALL
SELECT 'Publicados', '', COUNT(*)::text FROM travels WHERE status = 'published'
UNION ALL
SELECT 'Borradores', '', COUNT(*)::text FROM travels WHERE status = 'draft';

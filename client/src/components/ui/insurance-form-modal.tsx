            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => form.setValue("policyType", value)} value={form.watch("policyType")}>
                  <SelectTrigger 
                    className={form.formState.errors.policyType ? "border-red-500" : ""}
                    data-testid="select-policyType"
                  >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  data-testid="input-emergencyNumber"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  data-testid="input-effectiveTime"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                data-testid="input-importantInfo"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                data-testid="input-policyDescription"
              />
            </div>
          </div>
